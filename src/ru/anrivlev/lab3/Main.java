...
public class Main {
    public static void task1(List<Employee> employees) {
        ...
        employees.stream().filter(isFemale).forEach(Accountant::paySalary);
    ...
    public static void task2(List<Employee> employees) {
        ...
        employees.stream().filter(isDept19).forEach(Accountant::paySalary);
    ...
    public static void task3(List<Employee> employees) {
        ...
        Predicate<Employee> isDept19 = e -> e.getDept().equals("19");
        employees.stream().filter(isDept19).filter(isAgeOver30).forEach(e -> Accountant.paySalary((Employee) e));
        System.out.println("END OF TASK3\n");
    }
    public static void task4(List<Employee> employees) {
        System.out.println("TASK4");
        Predicate<Employee> isRoleManager = e -> e.getRole().equals(Role.MANAGER);
        employees.stream().filter(isRoleManager).forEach(e -> Accountant.paySalary((Employee) e));
    ...
    public static void task5(List<Employee> employees) {
        ...
        employees.stream().filter(isRoleStaff).forEach(e -> Accountant.payPremium((Employee) e));
    ...
    public static void task6(List<Employee> employees) {
        ...
        employees.stream().forEach(paySalary);
